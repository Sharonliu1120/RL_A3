...
def train_single_seed(
    ...
    csv_path = f"results/a2c_seed_{seed}.csv"
    ...
    torch.save(policy_net.state_dict(), f"results/a2c_policy_seed_{seed}.pt")
    torch.save(value_net.state_dict(), f"results/a2c_value_seed_{seed}.pt")
...
def train_multiple_seeds():
    ...
    plot_algorithm_interpolated(
        csv_paths=[f"results/a2c_seed_{seed}.csv" for seed in seeds],
        output_path="results/a2c_interp.png",
        title="A2C (Interpolated, 3 seeds)"
    )
